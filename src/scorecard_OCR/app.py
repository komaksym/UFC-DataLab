...
def read_images(folder_path: str) -> List[str]:
...
def process_scorecards(folder_path: str, output_path: str, num_workers: int = 8):
...
if __name__ == "__main__":
    FOLDER_PATH = 'datasets/scorecards/scraped_scorecard_images/new_version_scorecards/'
    OUTPUT_PATH = 'datasets/scorecards/OCR_parsed_scorecards/parsed_scorecards_new_version.csv'
