...
class TestStatsSpider:
    def setup_method(self):
        ...
        # Storing mock pages
        self.mock_pages = {
            'events_page': create_full_path("dummy_pages_to_scrape/dummy_events_page/events_page.html"),
            'single_event': create_full_path("dummy_pages_to_scrape/dummy_event_page/single_event_page.html"),
            'single_fight': create_full_path("dummy_pages_to_scrape/dummy_fight_page/fight_page.html")
        }     
