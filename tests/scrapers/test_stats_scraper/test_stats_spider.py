...
class TestStatsSpider:
    ...
    def test_parse_event(self, mock_metadata):
        ...
        responses = self.spider.parse_event(self.mock_response(self.mock_pages['single_event']))
        # Unpacking generator
    ...
    def test_parse_fight(self, mock_metadata):
        response = self.spider.parse_fight(self.mock_response(self.mock_pages['single_fight'], mock_metadata))
        # Unpacking generator
